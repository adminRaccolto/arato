  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        chave_acesso:    { type: "string",  description: "Chave de acesso da NF-e — 44 dígitos, geralmente impressos abaixo do código de barras/QR code no DANFE. Extraia se estiver visível na foto; senão deixe em branco." },
