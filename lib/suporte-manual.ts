...
**Removido (17/09/2026) — checkbox "Excluir receitas de produtores PJ":** existia na aba Exportação pra remover do Livro Caixa receitas atribuídas a um "produtor" que no cadastro é na verdade uma empresa (CNPJ). Removido junto com a reversão da visão de Empresa (PJ) no Relatório PDF — a resolução correta de PF/PJ agora é pelo campo Entidade Contábil no próprio lançamento (Módulo 15), não por essa heurística baseada no cadastro de Produtores.
