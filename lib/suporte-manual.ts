...
**Correção 23/09/2026 — MDF-e rejeitado com "Seguro da carga é obrigatório...":** faltava o grupo inteiro de Seguro da Carga no XML — obrigatório no MDF-e 3.00, nunca foi incluído. Corrigido: todo MDF-e agora declara o emitente como responsável pelo seguro (respSeg=1), a única informação exigida nesse caso — não precisa de apólice/seguradora cadastrada pra isso funcionar.
