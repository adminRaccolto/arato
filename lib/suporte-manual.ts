...
**Novo 23/09/2026 — Motorista pode ser digitado livre, sem precisar cadastrar:** o campo "Motorista" (CT-e, MDF-e, Expedição de Grãos e Transferência de Máquinas) deixou de ser um seletor fechado — agora é um campo de texto com sugestões do cadastro (digite e escolha, ou digite qualquer nome que não esteja cadastrado). Quando o nome bate com um motorista já cadastrado, o vínculo estruturado (CPF, tipo CLT/TAC) é mantido normalmente; quando não bate, salva só como texto mesmo, sem exigir cadastro prévio.
