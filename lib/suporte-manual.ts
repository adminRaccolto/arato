...
**Excluir receitas de produtores PJ:** checkbox na aba Exportação — desligado por padrão. Não é sobre quem comprou/pagou (comprador pessoa jurídica é normal — trading, cerealista — e é receita real). É sobre o "produtor" a quem a receita foi atribuída: o cadastro de Produtores mistura pessoas físicas de verdade com empresas (ex: "OGLIARI AGROPECUARIA LTDA") que também aparecem como titular de alguma fazenda. Marcado, remove do Livro Caixa qualquer receita cujo produtor (do lançamento ou herdado da fazenda) seja, no cadastro, uma empresa — em tudo (tela, KPIs, Resumo Mensal, .txt, Excel e Relatório PDF), sem mexer em nenhum lançamento do Financeiro. Se ao marcar o filtro quase toda a receita sumir, é sinal de que o cadastro de fazendas está apontando pro titular errado (a empresa, não a pessoa física) — vale corrigir o cadastro em vez de deixar o filtro sempre ligado.
