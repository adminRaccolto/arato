      ...
      <div style={{ background: "#F4F6FA", minHeight: "calc(100vh - 200px)", padding: "22px 32px" }}>
        ...
        {!loading && aba === "comercializacao" && (() => {
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            ...
            {/* REMOVIDO — código legado comercialização */ false && (() => {
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                  <div>
                    ...
                    <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
                      ...
                      {c.produtorNome && (
                        <div>
                          <span style={{ fontSize: 10, color: "rgba(255,255,255,0.5)", display: "block" }}>PRODUTOR</span>
