  ...
  return (
    <div style={{ fontFamily: "system-ui, sans-serif", background: "var(--bg-page)", minHeight: "100vh" }}>
      ...
      <nav style={{
        ...
        <Link href="/planos">
          <Image src="https://ptbougxydvxxdlhywhps.supabase.co/storage/v1/object/public/logos/Logo_Arato_Nova.png" alt="Arato" width={82} height={34} priority style={{ objectFit: "contain", cursor: "pointer" }} />
        </Link>
