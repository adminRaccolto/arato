    ...
    <div style={{ display: "flex", flexDirection: "column", minHeight: "100vh", background: "#F3F6F9", fontFamily: "system-ui, sans-serif", fontSize: 13 }}>
      ...
      <main style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
        <header style={{ background: "#fff", borderBottom: "0.5px solid #D4DCE8", padding: "10px 22px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <button style={btnV} onClick={() => setModal(true)}>+ Registrar Plantio</button>
        </header>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                <thead>
                  <tr style={{ background: "#F3F6F9" }}>
                    {["Safra / Talhão", "Semente / Cultivar", "Área", "Dose / Qtd Total", "Data Plantio", "Colheita Prev.", "Produt. Esp.", "Receita Esp.", "Custo Semente", ""].map((h, i) => (
                      <th key={i} style={{ padding: "8px 12px", textAlign: i === 0 ? "left" : "center", fontSize: 11, fontWeight: 600, color: "#555", borderBottom: "0.5px solid #D4DCE8", whiteSpace: "nowrap" }}>{h}</th>
                    ))}
                  </tr>
                </thead>
                <tbody>
      ...
      {modal && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.45)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 110 }}
          ...
          <div style={{ background: "#fff", borderRadius: 14, padding: 26, width: 680, maxWidth: "96vw", maxHeight: "92vh", overflowY: "auto" }}>
            <div style={{ color: "#1a1a1a", fontWeight: 600, fontSize: 15, marginBottom: 18 }}>Registrar Plantio</div>
